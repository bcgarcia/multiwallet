...
class PrivateContainer extends Component{
    ...
    toogleHeader(){this.props.appActions.toggleHeader(!this.props.app.headerOpen)}

    toggleUserNotifications(){this.props.appActions.toggleUserNotifications(!this.props.app.userNotificationsOpen)}

    toggleUserOptions(){this.props.appActions.toggleUserOptions(!this.props.app.userOptionsOpen)}
